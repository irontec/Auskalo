...
static Resource smallResource  =    { cocos2d::CCSizeMake(480, 960),    "iphone"         };
static Resource mediumResource =    { cocos2d::CCSizeMake(640, 1136),   "ipad"           };
static Resource largeResource =     { cocos2d::CCSizeMake(1536, 2040),  "ipadhd"         };
...
#elif (TARGET_DESIGN_RESOLUTION_SIZE == DESIGN_RESOLUTION_1536X2040)
static cocos2d::CCSize designResolutionSize = cocos2d::CCSizeMake(1536, 2040);
#else
